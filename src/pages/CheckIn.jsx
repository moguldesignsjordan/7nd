export default function CheckIn() {
  return <StubPage emoji="✅" eyebrow="Morning · Midday · Evening" title="Daily Check‑In" desc="Quick questions that feed your readiness score and AI coaching response" />
}
